...
public class PrivacyPolicyTests extends BaseTest {
    ...
    public void testPrivacyPolicyLoads() { init(); ReportManager.getTest().log(Status.INFO, "Privacy policy page"); a.assertTrue(true, "Privacy page loaded"); a.assertAll(); }

    @Test(groups = {TestGroups.REGRESSION, TestGroups.P3}, description = "Terms and conditions page loads")
    public void testTermsLoads() { init(); a.assertTrue(true, "Terms page loaded"); a.assertAll(); }
}
